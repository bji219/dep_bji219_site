...
### Demo
Now all these images and code snippets are great and all, but who cares about them if the thing sounds terrible (don't worry, it doesn't)? I recorded some short clips of myself playing the instrument and included them here for your sonic enjoyment.
